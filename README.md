...
本项目附带一套按"分治"思想组织的 **22 章源码精读导读**（docsify 站点）：

- 本地阅读：仓库根目录运行 `python -m http.server 3000`，浏览器打开 `http://localhost:3000/docs/`
- 在线部署：见 [`docs/appendix_deploy.md`](docs/appendix_deploy.md)（GitHub Pages 从 `/docs` 发布，零构建）
